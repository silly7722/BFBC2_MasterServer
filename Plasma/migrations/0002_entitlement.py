    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('grantDate', models.DateTimeField(auto_now_add=True,
                                                   help_text='Date when this entitlement was (or will be) granted.',
                                                   verbose_name='Grant Date')),
                ('terminationDate',
                 models.DateTimeField(blank=True, help_text='Date when this entitlement will be terminated.', null=True,
                                      verbose_name='Termination Date')),
                ('groupName',
                 models.CharField(blank=True, help_text='Name of the group this entitlement grants access to.',
                ...
                ('version',
                 models.IntegerField(default=0, help_text='Version of the entitlement.', verbose_name='Version')),
                ('isGameEntitlement',
                 models.BooleanField(default=False, help_text='Is this entitlement a game entitlement?',
