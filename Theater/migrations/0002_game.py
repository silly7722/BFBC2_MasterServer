        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.TextField(
                        help_text="Name of the server", verbose_name="Server Name"
                    ),
                ),
                (
                    "addrIp",
                    models.GenericIPAddressField(
                        help_text="IP Address of the server", verbose_name="IP Address"
                    ),
                ),
                (
                    "addrPort",
                    models.IntegerField(
                        help_text="Port of the server", verbose_name="Port"
                    ),
                ),
                (
                    "joiningPlayers",
                ...
                (
                    "maxPlayers",
                    models.IntegerField(
                        help_text="Maximum number of players in the server",
                ...
                (
                    "platform",
                    models.CharField(
                        choices=[("xenon", "Xbox360"), ("ps3", "Ps3"), ("PC", "Pc")],
                ...
                (
                    "joinMode",
                    models.CharField(
                        choices=[("C", "Closed"), ("W", "Wait"), ("O", "Open")],
                ...
                (
                    "serverVersion",
                    models.CharField(
                        help_text="Version of the server",
                        max_length=16,
                        verbose_name="Server Version",
                    ),
                ),
                (
                    "clientVersion",
                ...
                (
                    "gameTime",
                    models.TextField(
                        help_text="Uptime of the server",
                        null=True,
                        verbose_name="Uptime",
                    ),
                ),
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Is the game public?",
                        verbose_name="Game Public",
                    ),
                ),
                (
                    "gameElo",
                    models.IntegerField(
                        default=1000,
                        help_text="Current Elo of the server",
                        verbose_name="Game Elo",
                    ),
                ),
                (
                    "gameAutoBalance",
                ...
                (
                    "numObservers",
                    models.IntegerField(
                        help_text="Number of observers in the server",
                        verbose_name="Game Observers",
                    ),
                ),
                (
                    "maxObservers",
                ...
                (
                    "queueLength",
                    models.IntegerField(
                        help_text="Length of the queue", verbose_name="Queue Length"
                    ),
                ),
                (
                    "punkBusterVersion",
                ...
                (
                    "lobby",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="Theater.lobby"
                    ),
                ),
                (
                    "owner",
